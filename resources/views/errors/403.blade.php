...
<body class="bg-slate-950 text-slate-300 antialiased min-h-screen flex flex-col relative overflow-x-hidden">
    ...
    <main class="flex-1 flex items-center justify-center px-6 py-16 relative z-10">
        <div class="text-center max-w-lg">
            <p class="text-7xl md:text-8xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 text-transparent bg-clip-text mb-6">403</p>
            <h1 class="text-2xl md:text-3xl font-bold text-white mb-4">Access Forbidden</h1>
            <p class="text-slate-400 leading-relaxed mb-8">You don't have permission to access this page. If you think this is a mistake, please contact me.</p>
