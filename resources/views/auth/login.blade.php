    ...
    <div class="w-full max-w-md relative">
        ...
        <div class="bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-2xl shadow-indigo-950/40 border border-white/10 p-8">
            ...
            <form method="POST" action="{{ route('login.attempt') }}" class="space-y-5" data-validate data-validate-messages='@json((new \App\Http\Requests\LoginRequest)->messages())' data-validate-error-class="text-red-500 text-xs mt-1">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-slate-300 mb-1.5">Password <span class="text-red-500">*</span></label>
                    <div class="relative">
                ...
                <div class="flex items-center justify-between">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="remember" class="w-4 h-4 rounded accent-indigo-600 focus:ring-indigo-500">
                        <span class="text-sm text-slate-400">Remember me</span>
                    </label>
                    <a href="{{ route('password.request') }}" class="text-sm text-indigo-400 hover:text-indigo-300 font-medium">Forgot password?</a>
                </div>
