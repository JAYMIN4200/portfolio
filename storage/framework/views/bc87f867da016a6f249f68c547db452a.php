...
<div class="relative pl-8 pb-10 border-l-2 border-white/10 last:border-transparent" data-reveal="left">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-3 text-sm">
        <?php if($experience->website): ?>
            <a href="<?php echo e($experience->website); ?>" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 text-primary-400 font-medium hover:text-primary-300 transition-colors">
