    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 group">
                ...
                <span class="text-white font-semibold text-lg tracking-tight"><?php echo e($settings['site_title'] ?? config('app.name')); ?></span>
            </a>

            <div class="hidden md:flex items-center gap-8">
                <a href="<?php echo e(route('home')); ?>" class="nav-link text-sm font-medium transition-colors <?php echo e(request()->routeIs('home') ? 'text-white' : 'hover:text-white'); ?>">Home</a>
                <a href="<?php echo e(route('about')); ?>" class="nav-link text-sm font-medium transition-colors <?php echo e(request()->routeIs('about') ? 'text-white' : 'hover:text-white'); ?>">About</a>
                <a href="<?php echo e(route('projects.index')); ?>" class="nav-link text-sm font-medium transition-colors <?php echo e(request()->routeIs('projects.*') ? 'text-white' : 'hover:text-white'); ?>">Projects</a>
                <a href="<?php echo e(route('home') . '#services'); ?>" class="nav-link text-sm font-medium transition-colors hover:text-white">Services</a>
                <a href="<?php echo e(route('contact')); ?>" class="nav-link text-sm font-medium transition-colors <?php echo e(request()->routeIs('contact') ? 'text-white' : 'hover:text-white'); ?>">Contact</a>

                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-sm font-semibold shadow-lg shadow-indigo-500/30 hover:shadow-indigo-500/50 hover:scale-[1.02] transition-all">
                    Hire Me
