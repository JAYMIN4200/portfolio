        ...
        <aside class="hidden lg:flex fixed inset-y-0 left-0 w-64 bg-slate-900 flex-col z-30">
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="<?php echo e(route('admin.messages.index')); ?>" class="aside-link flex items-center justify-between gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.messages.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                    ...
                    <?php if($unread > 0): ?>
                        <span class="inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full text-xs font-bold bg-red-500 text-white"><?php echo e($unread); ?></span>
                    <?php endif; ?>
                </a>

                <p class="px-4 pt-5 pb-2 text-xs font-semibold uppercase tracking-wider text-slate-600">Content</p>

                <a href="<?php echo e(route('admin.skills.index')); ?>" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.skills.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    Skills
                </a>
                <a href="<?php echo e(route('admin.experiences.index')); ?>" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.experiences.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                    Experience
                </a>
                <a href="<?php echo e(route('admin.projects.index')); ?>" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.projects.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                ...
                <a href="<?php echo e(route('admin.services.index')); ?>" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.services.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                    Services
                </a>
                ...
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800 transition-colors'); ?>">
                ...
                <a href="<?php echo e(route('home')); ?>" target="_blank" class="aside-link flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800 transition-colors">
            ...
            <div class="p-4 border-t border-slate-800">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-slate-500 text-xs truncate"><?php echo e(auth()->user()->email); ?></p>
                    </div>
            ...
            <header class="sticky top-0 z-20 bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-6">
                ...
                <div class="hidden sm:flex items-center gap-2 text-sm">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="inline-flex items-center gap-1.5 text-slate-500 hover:text-indigo-600 transition-colors">
                ...
                <div class="flex items-center gap-4">
                    <span class="text-sm text-slate-500 hidden sm:block">Welcome back, <?php echo e(auth()->user()->name); ?></span>
            ...
            <div data-mobile-admin-sidebar class="hidden fixed inset-0 z-40 lg:hidden">
                ...
                <div class="absolute inset-y-0 left-0 w-64 bg-slate-900 flex flex-col overflow-y-auto">
                    ...
                    <nav class="py-4 px-3 space-y-1 flex-1">
                        ...
                        <a href="<?php echo e(route('admin.skills.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.skills.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'); ?>">Skills</a>
                        <a href="<?php echo e(route('admin.experiences.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.experiences.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'); ?>">Experience</a>
                        <a href="<?php echo e(route('admin.projects.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.projects.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'); ?>">Projects</a>
                        <a href="<?php echo e(route('admin.services.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.services.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'); ?>">Services</a>
                        <a href="<?php echo e(route('admin.settings.index')); ?>" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium <?php echo e(request()->routeIs('admin.settings.*') ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:text-white hover:bg-slate-800'); ?>">Settings</a>
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-3 px-4 py-2.5 rounded-lg text-sm font-medium text-slate-400 hover:text-white hover:bg-slate-800">View Website</a>
                    </nav>
                    <div class="p-4 border-t border-slate-800">
                        <div class="flex items-center gap-3">
                            <div class="w-9 h-9 rounded-full bg-indigo-600 flex items-center justify-center text-white font-semibold text-sm uppercase"><?php echo e(substr(auth()->user()->name, 0, 1)); ?></div>
                            <p class="text-white text-sm font-medium truncate"><?php echo e(auth()->user()->name); ?></p>
                        </div>
                    </div>
                </div>
